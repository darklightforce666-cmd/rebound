...
test('copy, source, fixtures, docs, vector assets, and preview pass terminology audit',()=>{
  const banned=[new RegExp('USD'+'G','i'),new RegExp('eligible'+'\\s+holders?','i'),new RegExp('up'+'lift','i'),new RegExp('buy'+'back','i'),new RegExp('solana token'+' markets','i'),new RegExp('solana'+' ecosystem','i'),new RegExp('80'+'% (?:holders|of net)','i'),new RegExp('80 /'+' 15 / 5'),/[\u2013\u2014]/,/&(?:mdash|ndash);/i];
